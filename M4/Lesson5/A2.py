# In this assignment, you will build a Library Book Availability Checker using Python. You will pair book names with copy counts, filter available books, update late fees using map(), combine values with zip(), and stop the program early when a chosen book is unavailable.
